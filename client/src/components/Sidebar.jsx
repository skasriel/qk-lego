  ...
  return (
    ...
    >
      <div style={styles.text}>
        {icon && (
          <ion-icon name={icon} style={{ marginRight: '10px', fontSize: '1.2em' }}></ion-icon>
        )}
        <span>{text}</span>
        {children}
      </div>
        ...
        <div style={styles.visible}>
          ...
          <div style={styles.content}>
            <SidebarButton
              ...
              text="Save Scene"
              onClick={() =>
                this.setState({ showSceneDialog: true, sceneDialogMode: 'save', saveName: '' })
              }
            />
          </div>
          ...
          <div style={styles.content}>
            <SidebarButton
              ...
              text={`Load Scene (${scenes.length})`}
              onClick={() => this.setState({ showSceneDialog: true, sceneDialogMode: 'load' })}
            />
          </div>
        ...
        {showSceneDialog &&
          ReactDOM.createPortal(
            <div
              ...
              onClick={() => this.setState({ showSceneDialog: false, saveName: '' })}
            >
              <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
                <div style={styles.modalHeader}>
                  {sceneDialogMode === 'save' ? 'Save Scene' : 'Load Scene'}
                </div>
                <div style={styles.modalContent}>
                          ...
                          <div style={{ maxHeight: '200px', overflowY: 'auto' }}>
                            {scenes.map((scene) => (
                              <div
                                ...
                                onClick={() => this.setState({ saveName: scene.name })}
                              >
                  ...
                  {sceneDialogMode === 'load' && (
                    <>
                      {scenes.length === 0 ? (
                        <div style={{ color: '#A0CCFF', textAlign: 'center', padding: '20px' }}>
                          No saved scenes
                        </div>
                      ) : (
                        <div style={{ maxHeight: '300px', overflowY: 'auto' }}>
                          {scenes.map((scene) => (
                            <div
                              ...
                              onClick={() => this.handleLoad(scene.filename)}
                            >
                              <div style={{ flex: 1 }}>
                ...
                <div style={styles.modalFooter}>
                  ...
                  >
                    {sceneDialogMode === 'save' ? 'Cancel' : 'Close'}
                  </button>
                  {sceneDialogMode === 'save' && (
                    <button
                      ...
                      style={{
                        padding: '8px 16px',
                        backgroundColor: saveName.trim() ? '#4a6fa5' : '#334466',
                        color: '#FFF',
                        border: 'none',
                        borderRadius: '4px',
